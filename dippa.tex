...
\subsection{1. Tiimihengen ja luottamuksen puute}
...
\subsection{2. Kommunikaatio-ongelmat}
...
\subsection{3. Tiedonkulkuongelmat}

\subsection{4. Epämotivoiva työnjako}

\subsection{5. Estimointi tehtiin muiden kuin toteuttajien taholta}
...
\subsection{6. Epärealistiset tavoitteet}
% Mahdoton deadline yleisellä tasolla

\subsection{7. Kasvava tekninen velka}
% Kasvanut tekninen velka
% Ei testattavaa
% Ei toimi "kerralla kuntoon" (monta testauskertaa)

\subsection{8. Iteratiivista prosessia ei toteuteta oikein}
